...
$(document).ready(function() {
	...
	$("#btn_add_featureMandSemiWhite").button({
        icons: {
            primary: "ui-icon-circle-plus"
        }
    }).click(function() {
	...
	$("#btn_add_featureMandSemiBlack").button({
        icons: {
            primary: "ui-icon-circle-plus"
        }
    }).click(function() {
	...
	$("#btn_add_featureOpSemiBlack").button({
        icons: {
            primary: "ui-icon-circle-plus"
        }
    }).click(function() {
	...
	$("#btn_add_featureSemiBlack").button({
        icons: {
            primary: "ui-icon-circle-plus"
        }
    }).click(function() {
	...
	$("#btn_add_featureSemiWhite").button({
        icons: {
            primary: "ui-icon-circle-plus"
        }
    }).click(function() {
		...
		$("#btn_add_featureOpSemiWhite").button({
        icons: {
            primary: "ui-icon-circle-plus"
        }
    }).click(function() {
...
var Feature = function(flag) {
    ...
    this.initialize = function(flag) {
        ...
        this.html_id = "feature" + seed; //gera id
    ...
    this.makeMainBox = function() {
        ...
        this.rect.setAttribute('id', this.html_id + "rect");
    ...
    this.makeLabel = function() {
        ...
        this.optLabel.setAttribute('id', this.html_id + "optLabel");
        this.optLabel.setAttribute('x', 220);
        this.optLabel.setAttribute('y', 225);
        this.optLabel.setAttribute('fill', "black");
        var textNode = document.createTextNode(this.html_id + "text");
	 ...
	 this.makeGroupModifier = function(flag) {
        ...
        this.optSemi.setAttribute('id', this.html_id + "optSemi");
    ...
    this.makeOptCircle = function(flag) {
            ...
            this.optcircle.setAttribute('id', this.html_id + "optcircle");
    ...
    this.makeMask = function(flag) {
        ...
        this.mascara.setAttribute('id', this.html_id + "mask");
