<?php	
	...
	if(!empty($_SESSION["usuario"])){
		...
		if(!empty($nome)){
			$caminho = 'C:\\\\xampp\\\htdocs\\\atlas\\\atlas\\\arquivos\\\\FeatuRESB\\\\Community\\\\'.$_POST["nome"];
			$query = "INSERT INTO arquivo VALUES(null,86,'$nome','$caminho',$idUsuario,1)";
		}else{
		...
		$ponteiro = fopen("../arquivos/FeatuRESB/Community/"."$nome","w+");
