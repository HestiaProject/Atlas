...
<script>
	...
	function saveDiagram(){
		...
		ajax.open("POST","../Escreve/escreve2.php",true);
		ajax.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		ajax.send("nome="+nome+"&arquivo="+conteudo+"&seed="+seed+"&feature="+quantF+"&dynamic="+quantDyn+"&static="+quantSta);
	...
	function saveDiagramCommunity(){
		...
		ajax.open("POST","../Escreve/escreveFeatCommunity.php",true);
		ajax.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	...
	function openList(){
        ...
        ajax.open("POST","../Impressoes/imprimirListaF.php",true);
		ajax.setRequestHeader("Content-type","application/x-www-form-urlencoded");
        ajax.send();
	}
...
<div class="menu">
	...
	<div class="menu1" id="context_menu_diagram">
		<a id="btn_add_feature" href="#"data-toggle="tooltip" title="Add Feature"><input type="image" src="./icons/feat/1.png" ></a>
		<input type="image" src="./icons/barra.png">
		<a id="btn_add_featureMand" href="#"data-toggle="tooltip" title="Add Feature Dynamic binding"><input type="image" src="./icons/feat/3.png" ></a>
		<input type="image" src="./icons/barra.png">
		<a id="btn_add_featureOp" href="#"data-toggle="tooltip" title="Add Feature Static binding"><input type="image" src="./icons/feat/2.png" ></a>
		<input type="image" src="./icons/barra.png">
